...
webDB.setupTables = function () {
  html5sql.process(
    'CREATE TABLE IF NOT EXISTS articles(id INTEGER PRIMARY KEY, title VARCHAR(255) NOT NULL, category VARCHAR(255) NOT NULL, author VARCHAR(255) NOT NULL, authorSlug VARCHAR(255), authorUrl VARCHAR(255), publishedOn DATE NOT NULL, markdown VARCHAR NOT NULL);',
    function() {
      // on success
